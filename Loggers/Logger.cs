...
public static class Logger
{
    ...
    public static void Trace(object message, [CallerMemberName] string memberName = "",
        [CallerFilePath] string callerFilePath = null)
    {
        if (message != null)
        {
        ...
        [CallerFilePath] string callerFilePath = null)
    {
        ...
        string errorMessage = $"{callerTypeName}.{memberName}: {message}";
    ...
    public static void Error(string message, Exception exception, [CallerMemberName] string memberName = "",
        [CallerFilePath] string callerFilePath = null)
    {
        string callerTypeName = Path.GetFileNameWithoutExtension(callerFilePath);
